							...
							<td id="tabel1">
								...
								echo "<div class='masthead'>
										<ul class='nav nav-justified'>
										  ...
										  <li class='active'><a href='../home/class-schedule.php?id=".$id."'>Class Offered</a></li>
				...
				<table id="welcome" border="0" cellspacing="0" cellpadding="0" style="width:100%;" class="col-md-12">
					<tbody>
						<tr valign="top">
							...
							<table>
								<tr>
									<td><button class="btn btn-primary" data-toggle="modal" data-target="#myModal">Add Class</button></a></td>
									<td><?php echo"<a href=\"../home/deleteclass.php?id=".$id."\">";?><button class="btn btn-primary">Delete Class</button></td>
									
									<table class="table"><br/>
										<tr><td>Class</td><td>Teacher</td><td>Schedule</td><td>Classroom</td></tr>
										<?php
												$id=$_GET['id'];
												$sql=mysql_query("SELECT * FROM `class_schedule` where status='Okay'");
							...
							<table class="table">
								...
								<tr>
									...
									<td><select name="classroom"  class="form-control" required>
										...
										<option value='Class 1'>A. Einstein Room</option>
										<option value='Class 2'>J. S. Bach Room</option>
										<option value='Class 3'>C. Dickens Room</option>
